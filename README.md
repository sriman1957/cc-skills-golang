...
| --- | ----------------------------------- | -------- | -------------- | ----------------- | -------------- | --------------- |
| ⭐️   | ✅ `golang-code-style`               | ⚙️        | -40%           | 31                | 2,070          | 2,686           |
| ⭐️   | ✅ `golang-data-structures`          |          | -39%           | 92                | 2,464          | 6,176           |
| ⭐️   | ✅ `golang-database`                 | ⚙️        | -38%           | 112               | 2,725          | 7,210           |
...
| ⭐️   | ✅ `golang-troubleshooting`          | ⚡ 🧠      | -32%           | 106               | 2,709          | 15,875          |
| ⭐️   | ✅ `golang-security`                 | ⚡ 🧠      | -32%           | 84                | 2,873          | 20,894          |
|     | ✅ `golang-benchmark`                | ⚡ 🧠      | -50%           | 92                | 2,106          | 29,190          |
...
|     | ✅ `golang-observability`            | ⚡ ⚙️      | -37%           | 144               | 2,893          | 18,400          |
|     | ✅ `golang-performance`              | ⚡ 🧠      | -39%           | 108               | 1,953          | 17,823          |
...
| ❌ `golang-samber-hot`         |       | —              | 0                 | 0              | 0               |
| ❌ `golang-samber-lo`          |       | —              | 0                 | 0              | 0               |
| ❌ `golang-samber-mo`          |       | —              | 0                 | 0              | 0               |
| ✅ `golang-samber-oops`        |       | -59%           | 69                | 2,380          | 2,692           |
| ❌ `golang-samber-ro`          |       | —              | 0                 | 0              | 0               |
| ❌ `golang-samber-slog`        |       | —              | 0                 | 0              | 0               |
